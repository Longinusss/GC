...
public class MainController {
    ...
    public ModelAndView signin(){
        ModelAndView signinPage=new ModelAndView("/pages/signin.jsp");
    ...
    public ModelAndView signup(){
        ModelAndView signupPage=new ModelAndView("/pages/signup.jsp");
    ...
    public ModelAndView newTopic(){
        ModelAndView newTopicPage=new ModelAndView("/pages/new.jsp");
